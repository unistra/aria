...
<?php
  ...
  if(isset($_POST["valider"]) || isset($_POST["valider_x"]))
  {
    ...
    {
      db_query($dbr,"INSERT INTO $_DB_dossiers_elems_contenu VALUES (
                      '$candidat_id', 
                      '$_SESSION[elem_id]', 
                      '$_SESSION[comp_id]', 
    ...
    {
      db_query($dbr, "UPDATE $_DB_dossiers_elems_contenu 
                      SET $_DBU_dossiers_elems_contenu_para='".preg_replace("/[']+/", "''", stripslashes($contenu))."'
