      ...
      if($deja_inscrit==1 && $num_ine=="") 
         ...
         && !isset($erreur_ine_obligatoire))
		{
			...
			if(array_key_exists($pays_naissance_code, $_SESSION["liste_pays_nat_iso"]))
				$_SESSION["pays_naissance"]=htmlspecialchars(stripslashes($_SESSION["liste_pays_nat_iso"]["$pays_naissance_code"]["pays"]), ENT_QUOTES);
			else
				$_SESSION["pays_naissance"]="";

			if(array_key_exists($adr_pays_code, $_SESSION["liste_pays_nat_iso"]))
				$_SESSION["adresse_pays"]=htmlspecialchars(stripslashes($_SESSION["liste_pays_nat_iso"]["$adr_pays_code"]["pays"]), ENT_QUOTES);
			else
				$_SESSION["adresse_pays"]="";

			if(array_key_exists($nationalite_code, $_SESSION["liste_pays_nat_iso"]))
				$_SESSION["nationalite"]=htmlspecialchars(stripslashes($_SESSION["liste_pays_nat_iso"]["$nationalite_code"]["nationalite"]), ENT_QUOTES);
			else
				$_SESSION["nationalite"]="";


			$_SESSION["nom"]=htmlspecialchars(stripslashes($nom), ENT_QUOTES);
			$_SESSION["nom_naissance"]=htmlspecialchars(stripslashes($nom_naissance), ENT_QUOTES);
			$_SESSION["civilite"]=htmlspecialchars(stripslashes($civilite), ENT_QUOTES);
			$_SESSION["prenom"]=htmlspecialchars(stripslashes($prenom), ENT_QUOTES);
			$_SESSION["prenom2"]=htmlspecialchars(stripslashes($prenom2), ENT_QUOTES);
			$_SESSION["naissance"]=htmlspecialchars(stripslashes($date_naissance), ENT_QUOTES);
			$_SESSION["lieu_naissance"]=htmlspecialchars(stripslashes($lieu_naissance), ENT_QUOTES);
			...
			$_SESSION["telephone"]=htmlspecialchars(stripslashes($telephone), ENT_QUOTES);
			$_SESSION["telephone_portable"]=htmlspecialchars(stripslashes($telephone_portable), ENT_QUOTES);
			$_SESSION["adresse_1"]=htmlspecialchars(stripslashes($adresse_1), ENT_QUOTES);
			$_SESSION["adresse_2"]=htmlspecialchars(stripslashes($adresse_2), ENT_QUOTES);
			$_SESSION["adresse_3"]=htmlspecialchars(stripslashes($adresse_3), ENT_QUOTES);
			$_SESSION["adresse_cp"]=$adr_cp;
			$_SESSION["adresse_ville"]=htmlspecialchars(stripslashes($adr_ville), ENT_QUOTES);
			$_SESSION["adresse_pays_code"]=$adr_pays_code;			
			$_SESSION["numero_ine"]=htmlspecialchars(stripslashes($num_ine), ENT_QUOTES);
			$_SESSION["email"]=htmlspecialchars(stripslashes($email), ENT_QUOTES);
...
<div class='main'>
	...
	<tr>
		...
		<td class='td-droite fond_menu'>
			<input type='text' name='nom' value='<?php if(isset($nom)) echo htmlspecialchars(stripslashes($nom), ENT_QUOTES); else echo htmlspecialchars(stripslashes($_SESSION["nom"]), ENT_QUOTES); ?>' size="25" maxlength="30">
		</td>
	</tr>
	<tr>
		<td class='td-gauche fond_menu2' style="text-align:right;">
		...
		<td class='td-droite fond_menu'>
			<input type='text' name='nom_naissance' value='<?php if(isset($nom_naissance)) echo htmlspecialchars(stripslashes($nom_naissance), ENT_QUOTES); else echo htmlspecialchars(stripslashes($_SESSION["nom_naissance"]), ENT_QUOTES); ?>' size="25" maxlength="30">
		</td>
	</tr>
	<tr>
		<td class='td-gauche fond_menu2' style="text-align:right;">
		...
		<td class='td-droite fond_menu'>
			<input type='text' name='prenom' value='<?php if(isset($prenom)) echo htmlspecialchars(stripslashes($prenom), ENT_QUOTES); else echo htmlspecialchars(stripslashes($_SESSION["prenom"]), ENT_QUOTES); ?>' size="25" maxlength="30">
		</td>
	</tr>
	<tr>
		<td class='td-gauche fond_menu2' style="text-align:right;">
		...
		<td class='td-droite fond_menu'>
			<input type='text' name='prenom2' value='<?php if(isset($prenom2)) echo htmlspecialchars(stripslashes($prenom2), ENT_QUOTES); else echo htmlspecialchars(stripslashes($_SESSION["prenom2"]), ENT_QUOTES); ?>' size="25" maxlength="30">
		</td>
	</tr>
	<tr>
		<td class='td-gauche fond_menu2' style="text-align:right;">
	...
	<tr>
		...
		<td class='td-droite fond_menu'>
			<input type='text' name='lieu_naissance' value='<?php if(isset($lieu_naissance)) echo htmlspecialchars(stripslashes($lieu_naissance), ENT_QUOTES); else echo htmlspecialchars(stripslashes($_SESSION["lieu_naissance"]), ENT_QUOTES); ?>' size="25" maxlength="60">
		</td>
	</tr>
	<tr>
		<td class='td-gauche fond_menu2' style="text-align:right;">
	...
	<tr>
		...
		<td class='td-droite fond_menu'>
			...
			<!-- <input type='text' name='pays_naissance' value='<?php if(isset($pays_naissance)) echo htmlspecialchars(stripslashes($pays_naissance), ENT_QUOTES); else echo	stripslashes($_SESSION["pays_naissance"]); ?>' size="25" maxlength="60"> -->
		</td>
	</tr>
	<tr>
		<td class='td-gauche fond_menu2' style="text-align:right;">
	...
	<tr>
		...
		<td class='td-droite fond_menu2'>
			<input type='text' name='email' value='<?php if(isset($email)) echo htmlspecialchars(stripslashes($email), ENT_QUOTES); else echo htmlspecialchars($_SESSION["email"],ENT_QUOTES); ?>' size="40" maxlength="255">
	...
	<tr>
		...
		<td class='td-droite fond_menu2'>
			<input type='text' name='emailconf' value='<?php if(isset($emailconf)) echo htmlspecialchars(stripslashes($emailconf), ENT_QUOTES); else echo htmlspecialchars($_SESSION["email"],ENT_QUOTES); ?>' size="40" maxlength="255">
		</td>
	</tr>
	<tr>
	...
	<tr>
      ...
      <td class='td-droite fond_menu' style="text-align:left;">
         <input name='adresse_1' value="<?php if(isset($adresse_1)) echo htmlspecialchars(stripslashes($adresse_1), ENT_QUOTES); else echo htmlspecialchars(stripslashes($_SESSION["adresse_1"]), ENT_QUOTES); ?>" size='40' maxlength="30">
      </td>
   </tr>
   <tr>
      <td class='td-gauche fond_menu2' style="text-align:right;">
      ...
      <td class='td-droite fond_menu' style="text-align:left;">
         <input name='adresse_2' value="<?php if(isset($adresse_2)) echo htmlspecialchars(stripslashes($adresse_2), ENT_QUOTES); else echo htmlspecialchars(stripslashes($_SESSION["adresse_2"]), ENT_QUOTES); ?>" size='40' maxlength="30">
      </td>
   </tr>
   <tr>
      <td class='td-gauche fond_menu2' style="text-align:right;">
      ...
      <td class='td-droite fond_menu' style="text-align:left;">
         <input name='adresse_3' value="<?php if(isset($adresse_3)) echo htmlspecialchars(stripslashes($adresse_3), ENT_QUOTES); else echo htmlspecialchars(stripslashes($_SESSION["adresse_3"]), ENT_QUOTES); ?>" size='40' maxlength="30">
      </td>
   </tr>
	<tr>
		<td class='td-gauche fond_menu2' style="text-align:right;">
		...
		<td class='td-droite fond_menu'>
			<input type='text' name='adr_cp' value='<?php if(isset($adr_cp)) echo htmlspecialchars(stripslashes($adr_cp), ENT_QUOTES); else echo htmlspecialchars(stripslashes($_SESSION["adresse_cp"]), ENT_QUOTES); ?>' size="25" maxlength="15">
		</td>
	</tr>
	<tr>
		<td class='td-gauche fond_menu2' style="text-align:right;">
		...
		<td class='td-droite fond_menu'>
			<input type='text' name='adr_ville' value='<?php if(isset($adr_ville)) echo htmlspecialchars(stripslashes($adr_ville), ENT_QUOTES); else echo htmlspecialchars(stripslashes($_SESSION["adresse_ville"]), ENT_QUOTES); ?>' size="25" maxlength="60">
		</td>
	</tr>
	<tr>
		<td class='td-gauche fond_menu2' style="text-align:right;">
	...
	<tr>
		...
		<td class='td-droite fond_menu'>
			<input type='text' name='num_ine' value='<?php if(isset($num_ine)) echo htmlspecialchars(stripslashes($num_ine), ENT_QUOTES); else echo htmlspecialchars($_SESSION["numero_ine"],ENT_QUOTES); ?>' size="25" maxlength="11"> <font class='Texte_menu'>(<b>obligatoire</b> en cas d'inscription antérieure dans cette Université)</font>
		</td>
	</tr>
	<tr>
      <td colspan='' class='fond_page' style='height:10px;'></td>
	...
	<tr>
		...
		<td class='td-droite fond_menu'>
			<input type='text' name='telephone' value='<?php if(isset($telephone)) echo htmlspecialchars(stripslashes($telephone), ENT_QUOTES); else echo stripslashes($_SESSION["telephone"]); ?>' size="25" maxlength="15">
		</td>
	</tr>
	<tr>
		<td class='td-gauche fond_menu2' style="text-align:right;">
		...
		<td class='td-droite fond_menu'>
			<input type='text' name='telephone_portable' value='<?php if(isset($telephone_portable)) echo htmlspecialchars(stripslashes($telephone_portable), ENT_QUOTES); else echo stripslashes($_SESSION["telephone_portable"]); ?>' size="25" maxlength="15">
		</td>
	</tr>
	</table>
