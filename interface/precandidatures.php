...
//					$requete.="INSERT INTO $_DB_dossiers_elems_contenu VALUES ('$candidat_id', '$element_id', '$_SESSION[comp_id]', '$para', '$__PERIODE'); ";
               $requete.="INSERT INTO $_DB_dossiers_elems_contenu VALUES ('$candidat_id', '$element_id', '$_SESSION[comp_id]', '$para', (SELECT max($_DBC_cand_periode) FROM $_DB_cand 
...
/*
	...
	if(count($_SESSION["array_lock"]))
	{
		foreach($_SESSION["array_lock"] as $p_id => $p_array)
			$__lock=$__lock | $p_array["lock"];
	}

	$_SESSION["lock"]=$__lock;
*/
	// ================================== VERROUILLAGE ===========================================
