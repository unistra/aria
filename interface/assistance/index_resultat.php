...
<div class='main'>
   <?php
       titre_page_icone("[Assistance aux candidats] - Résultats des candidatures", "help-browser_32x32_fond.png", 15, "L");
   ?>

   <table align='center' style='padding-bottom:20px;'>
   <tr>
      <td class='td-complet fond_menu2' style='padding:4px;'>
         <font class='Texte_menu2'><strong>Questions relatives aux résulats des candidatures</strong></font>
      </td>
   </tr>
   <tr>
      <td class='td-complet fond_menu2' style='padding:4px;'>
