...
<div class='main'>
   ...
   <tr>
      ...
      <td class='td-droite fond_menu'>
         <input type='text' name='num_ine' value='<?php if(isset($num_ine)) echo htmlspecialchars(stripslashes($num_ine), ENT_QUOTES); elseif(isset($_SESSION["numero_ine"])) echo htmlspecialchars($_SESSION["numero_ine"],ENT_QUOTES); ?>' size="25" maxlength="11"> <font class='Texte_menu'><i>(si vous en possédez un)</i></font>
      </td>
   </tr>
   <tr>
      <td class='td-gauche fond_menu2'>
