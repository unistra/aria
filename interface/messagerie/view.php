	...
	if(isset($_GET["p"]) && isset($_SESSION["msg_dir"]) && -1!=($params=get_params($_GET['p']))) // chemin complet du message, chiffré
	{
		if(isset($params["pj"]) && is_file("$_SESSION[msg_dir]/files/$params[pj]"))
		{
			...
			{ 
				...
				deltree("$__CAND_COMP_STOCKAGE_DIR_ABS/$_SESSION[comp_id]/$_SESSION[authentifie]");

				// echo "deltree $__CAND_COMP_STOCKAGE_DIR_ABS/$_SESSION[comp_id]/$_SESSION[authentifie]";
				mkdir("$__CAND_COMP_STOCKAGE_DIR_ABS/$_SESSION[comp_id]/$_SESSION[authentifie]", 0770, true);
			}

			copy("$_SESSION[msg_dir]/files/$params[pj]", "$__CAND_COMP_STOCKAGE_DIR_ABS/$_SESSION[comp_id]/$_SESSION[authentifie]/$params[pj]");

			echo "<HTML><SCRIPT>document.location='$__CAND_COMP_STOCKAGE_DIR/$_SESSION[comp_id]/$_SESSION[authentifie]/$params[pj]';</SCRIPT></HTML>";
		}
	}
?>
