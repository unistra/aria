...
<div class='main'>
	<?php
		if($nb_messages>1)
			message("Vous avez $nb_messages messages non lus, souhaitez-vous les lire maintenant (recommandé) ?", $__QUESTION);
		else
			message("Vous avez 1 message non lu, souhaitez-vous le lire maintenant (recommandé) ?", $__QUESTION);
	?>
