...
*/   
   ...
   // 04/12/2014 : table système : ajout d'un champ pour une adresse email 'noreply'
   // Objectif : utilisée comme adresse d'expédition pour les mails automatiques envoyés aux candidats
   if(!db_num_rows(db_query($db_maj, "SELECT * FROM information_schema.columns WHERE table_catalog='$__DB_BASE'
                                                                               AND table_name='$_DB_systeme'
