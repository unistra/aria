            ...
            */
			...
			if($_SESSION["niveau"]==$__LVL_ADMIN)
			{
				...
				if($formation=="orph")
				{
					...
					$requete=$_SESSION["requete"]="SELECT distinct($_DBC_candidat_id), $_DBC_candidat_civilite, to_ascii($_DBC_candidat_nom), to_ascii($_DBC_candidat_nom_naissance), 
														...
														$critere_id_inf
														$critere_id_sup
															ORDER BY to_ascii($_DBC_candidat_nom), to_ascii($_DBC_candidat_nom_naissance), $_DBC_candidat_prenom, $_DBC_candidat_date_naissance";
				}
				else
					$requete=$_SESSION["requete"]="SELECT distinct($_DBC_candidat_id), $_DBC_candidat_civilite, to_ascii($_DBC_candidat_nom), to_ascii($_DBC_candidat_nom_naissance),
																		$_DBC_candidat_prenom, $_DBC_candidat_date_naissance, $_DBC_candidat_lieu_naissance,
