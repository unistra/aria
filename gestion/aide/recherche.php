...
<div class='main'>
	...
	<div style='margin-left:auto; margin-right:auto; padding-bottom:20px; width:90%; text-align:justify;'>
		...
		<p class='Texte' style='padding-bottom:15px;'>
			<b>Trouver une ou plusieurs fiches à partir de critères multiples</b>
		</p>
		...
		<p class='Texte' style='padding-bottom:15px;'>
			...
			ou de son adresse électronique (<i>email</i>).
		</p>
		<p class='Texte' style='padding-bottom:15px;'>
			<u><b>Générale : formations et statuts des fiches</b></u> : second sous-menu pemettant de rechercher de multiples
			fiches en fonction d'une formation et des décisions rendues.
		<p class='Texte' style='padding-bottom:15px;'>
			<b>Les fonctionnalités de ces sous-menus sont détaillées dans l'aide de chacun d'entre eux.</b>
		</p>
	</div>
</div>
<?php
