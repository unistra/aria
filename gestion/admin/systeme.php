   ...
   <div class='corps_gestion'>
      ...
      <tr>
         ...
         <td class='td-droite fond_menu' style='width:50%; padding:4px;'>
            <font class='Texte_menu'>
               <input type='text' name='config[__TITRE_HTML]' value='<?php echo htmlspecialchars(stripslashes($titre_html), ENT_QUOTES); ?>' size='60' maxlength='128'>
            </font>
         </td>
      </tr>
      <tr>
         ...
         <td class='td-droite fond_menu' style='padding:4px;'>
            <font class='Texte_menu'>
               <input type='text' name='config[__TITRE_PAGE]' value='<?php echo htmlspecialchars(stripslashes($titre_page), ENT_QUOTES); ?>' size='60' maxlength='128'>
            </font>
         </td>
      </tr>
      <tr>
         ...
         <td class='td-droite fond_menu' style='padding:4px;'>
            <font class='Texte_menu'>
               <input type='text' name='config[__URL_CANDIDAT]' value='<?php echo htmlspecialchars(stripslashes($url_candidat), ENT_QUOTES); ?>' size='60' maxlength='256'>
            </font>
         </td>
      </tr>
      <tr>
         ...
         <td class='td-droite fond_menu' style='padding:4px;'>
            <font class='Texte_menu'>
               <input type='text' name='config[__URL_GESTION]' value='<?php echo htmlspecialchars(stripslashes($url_gestion), ENT_QUOTES); ?>' size='60' maxlength='256'>
            </font>
         </td>
      </tr>
      <tr>
         ...
         <td class='td-droite fond_menu' style='padding:4px;'>
            <font class='Texte_menu'>
               <input type='text' name='config[__META]' value='<?php echo htmlspecialchars(stripslashes($meta), ENT_QUOTES); ?>' size='60' maxlength='2048'>
            </font>
         </td>
      </tr>
      ...
      <tr>
         ...
         <td class='td-droite fond_menu' style='padding:4px;'>
            <font class='Texte_menu'>
               <input type='text' name='config[__LDAP_HOST]' value='<?php echo htmlspecialchars(stripslashes($ldap_host), ENT_QUOTES); ?>' size='60' maxlength='128'>
            </font>
         </td>
      </tr>
      <tr>
         ...
         <td class='td-droite fond_menu' style='padding:4px;'>
            <font class='Texte_menu'>
               <input type='text' name='config[__LDAP_PORT]' value='<?php echo htmlspecialchars(stripslashes($ldap_port), ENT_QUOTES); ?>' size='6' maxlength='5'>
            </font>
         </td>
      </tr>
      <tr>
      ...
      <tr>
         ...
         <td class='td-droite fond_menu' style='padding:4px;'>
            <font class='Texte_menu'>
               <input type='text' name='config[__LDAP_ID]' value='<?php echo htmlspecialchars(stripslashes($ldap_id), ENT_QUOTES); ?>' size='60' maxlength='128'>
            </font>
         </td>
      </tr>
      <tr>
         ...
         <td class='td-droite fond_menu' style='padding:4px;'>
            <font class='Texte_menu'>
               <input type='password' name='config[__LDAP_PASS]' value='<?php echo htmlspecialchars(stripslashes($ldap_pass), ENT_QUOTES); ?>' size='60' maxlength='128'>
            </font>
         </td>
      </tr>
      <tr>
         ...
         <td class='td-droite fond_menu' style='padding:4px;'>
            <font class='Texte_menu'>
               <input type='text' name='config[__LDAP_BASEDN]' value='<?php echo htmlspecialchars(stripslashes($ldap_basedn), ENT_QUOTES); ?>' size='60' maxlength='128'>
            </font>
         </td>
      </tr>
      <tr>
      ...
      <tr>
         ...
         <td class='td-droite fond_menu' style='padding:4px;'>
            <font class='Texte_menu'>
               <input type='text' name='config[__LDAP_ATTR_NOM]' value='<?php echo htmlspecialchars(stripslashes($ldap_attr_nom), ENT_QUOTES); ?>' size='25' maxlength='128'>
            </font>
         </td>
      </tr>
      <tr>
         ...
         <td class='td-droite fond_menu' style='padding:4px;'>
            <font class='Texte_menu'>
               <input type='text' name='config[__LDAP_ATTR_PRENOM]' value='<?php echo htmlspecialchars(stripslashes($ldap_attr_prenom), ENT_QUOTES); ?>' size='25' maxlength='128'>
            </font>
         </td>
      </tr>
      <tr>
         ...
         <td class='td-droite fond_menu' style='padding:4px;'>
            <font class='Texte_menu'>
               <input type='text' name='config[__LDAP_ATTR_LOGIN]' value='<?php echo htmlspecialchars(stripslashes($ldap_attr_login), ENT_QUOTES); ?>' size='25' maxlength='128'>
            </font>
         </td>
      </tr>
      <!--
      <tr>
         ...
         <td class='td-droite fond_menu' style='padding:4px;'>
            <font class='Texte_menu'>
               <input type='text' name='config[__LDAP_ATTR_PASS]' value='<?php echo htmlspecialchars(stripslashes($ldap_attr_pass), ENT_QUOTES); ?>' size='25' maxlength='128'>
            </font>
         </td>
      </tr>
      -->
      <tr>
         ...
         <td class='td-droite fond_menu' style='padding:4px;'>
            <font class='Texte_menu'>
               <input type='text' name='config[__LDAP_ATTR_MAIL]' value='<?php echo htmlspecialchars(stripslashes($ldap_attr_mail), ENT_QUOTES); ?>' size='25' maxlength='128'>
      ...
      <tr>
         ...
         <td class='td-droite fond_menu' style='padding:4px;'>
            <font class='Texte_menu'>
               <input type='text' name='config[__NOM_ADMIN]' value='<?php echo htmlspecialchars(stripslashes($nom_admin), ENT_QUOTES); ?>' size='60' maxlength='256'>
            </font>
         </td>
      </tr>
      <tr>
         ...
         <td class='td-droite fond_menu' style='padding:4px;'>
            <font class='Texte_menu'>
               <input type='text' name='config[__EMAIL_ADMIN]' value='<?php echo htmlspecialchars(stripslashes($email_admin), ENT_QUOTES); ?>' size='60' maxlength='128'>
            </font>
         </td>
      </tr>
      <tr>
         ...
         <td class='td-droite fond_menu' style='padding:4px;'>
            <font class='Texte_menu'>
               <input type='text' name='config[__EMAIL_SUPPORT]' value='<?php echo htmlspecialchars(stripslashes($email_support), ENT_QUOTES); ?>' size='60' maxlength='128'>
            </font>
         </td>
      </tr>
      <tr>
         ...
         <td class='td-droite fond_menu' style='padding:4px;'>
            <font class='Texte_menu'>
               <textarea name='config[__SIGNATURE_ADMIN]' cols='50' rows='5'><?php echo htmlspecialchars(stripslashes($signature_admin), ENT_QUOTES); ?></textarea>
            </font>
         </td>
      </tr>
      <tr>
         ...
         <td class='td-droite fond_menu' style='padding:4px;'>
            <font class='Texte_menu'>
               <textarea name='config[__SIGNATURE_COURRIELS]' cols='50' rows='5'><?php echo htmlspecialchars(stripslashes($signature_courriels), ENT_QUOTES); ?></textarea>
            </font>
         </td>
      </tr>
      ...
      <tr>
         ...
         <td class='td-droite fond_menu' style='padding:4px;'>
            <font class='Texte_menu'>
               <input type='text' name='config[__VILLE]' value='<?php echo htmlspecialchars(stripslashes($ville), ENT_QUOTES); ?>' size='60' maxlength='128'>
            </font>
         </td>
      </tr>
      <tr>
         ...
         <td class='td-droite fond_menu' style='padding:4px;'>
            <font class='Texte_menu'>
               <textarea name='config[__INFORMATIQUE_ET_LIBERTES]' cols='60' rows='7'><?php echo htmlspecialchars(stripslashes($informatique_liberte), ENT_QUOTES); ?></textarea>
            </font>
         </td>
      </tr>
      <tr>
      ...
      <tr>
         ...
         <td class='td-droite fond_menu' style='padding:4px;'>
            <font class='Texte_menu'>
               <input type='text' name='config[__ERREUR_SUJET]' value='<?php echo htmlspecialchars(stripslashes($erreur_sujet), ENT_QUOTES); ?>' size='60' maxlength='256'>
            </font>
         </td>
      </tr>
      <tr>
      ...
      <tr>
         ...
         <td class='td-droite fond_menu' style='padding:4px;'>
            <font class='Texte_menu'>
               <input type='text' name='config[__DEBUG_SUJET]' value='<?php echo htmlspecialchars(stripslashes($debug_sujet), ENT_QUOTES); ?>' size='60' maxlength='256'>
            </font>
         </td>
      </tr>
      <tr>
