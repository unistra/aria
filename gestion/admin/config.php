...
<div class='main'>
   ...
   <tr>
      ...
      <td class='fond_menu' style='padding:4px;'>
         ...
         ?>
         <font class='Texte_menu'><input type='text' name='db_host' value='<?php echo htmlspecialchars(stripslashes($cur_db_host), ENT_QUOTES, $GLOBALS["default_htmlspecialchars_encoding"], FALSE); ?>' size='60' maxlength='128'></font>
      </td>
   </tr>
   <tr>
      <td class='fond_menu2' style='padding:4px;'>
      ...
      <td class='fond_menu' style='padding:4px;'>
         <?php
            ...
            elseif(isset($file_db_port))
               ...
               $cur_db_port="5432";
         ?>
         <font class='Texte_menu'><input type='text' name='db_port' value='<?php echo htmlspecialchars(stripslashes($cur_db_port), ENT_QUOTES, $GLOBALS["default_htmlspecialchars_encoding"], FALSE); ?>' size='60' maxlength='128'></font>
      </td>
   </tr>
   <tr>
      <td class='fond_menu2' style='padding:4px;'>
      ...
      <td class='fond_menu' style='padding:4px;'>
         <?php
            ...
            elseif(isset($file_db_base))
               ...
               $cur_db_base="aria";
         ?>
         <font class='Texte_menu'><input type='text' name='db_base' value='<?php echo htmlspecialchars(stripslashes($cur_db_base), ENT_QUOTES, $GLOBALS["default_htmlspecialchars_encoding"], FALSE); ?>' size='60' maxlength='128'></font>
      </td>
   </tr>
   <tr>
      <td class='fond_menu2' style='padding:4px;'>
      ...
      <td class='fond_menu' style='padding:4px;'>
         <?php
            ...
            elseif(isset($file_db_user))
               ...
               $cur_db_user="login";
         ?>
         <font class='Texte_menu'><input type='text' name='db_user' value='<?php echo htmlspecialchars(stripslashes($cur_db_user), ENT_QUOTES, $GLOBALS["default_htmlspecialchars_encoding"], FALSE); ?>' size='60' maxlength='128'></font>
      </td>
   </tr>
   <tr>
      <td class='fond_menu2' style='padding:4px;'>
    ...
    <tr>
      ...
      <td class='fond_menu' style='padding:4px;'>
         ...
         <font class='Texte_menu'>
            <input type='text' name='rootdir' value='<?php echo htmlspecialchars(stripslashes($cur_rootdir), ENT_QUOTES, $GLOBALS["default_htmlspecialchars_encoding"], FALSE); ?>' size='40' maxlength='128'>
            <?php
               if(isset($root_auto))
   ...
   <tr>
      ...
      <td class='fond_menu' style='padding:4px;'>
         ...
         ?>
         <font class='Texte_menu'>
            <input type='text' name='appdir' value='<?php echo htmlspecialchars(stripslashes($cur_appdir), ENT_QUOTES, $GLOBALS["default_htmlspecialchars_encoding"], FALSE); ?>' size='40' maxlength='128'>
            <?php
               if(isset($app_auto))
                  echo "<strong>(autodétecté)</strong>";
            ?>
