...
<?php
	...
	$titre_page="Cursus des candidats - Gestion de la liste des mentions";

/*
	// table concernée
	$nom_table="cursus_mentions";
...
*/
	...
	$table=array("nom" => "cursus_mentions",
					 "pkey" => "id",
					 "selection" => "intitule",
					 "order" => "intitule",
					 "colonnes" => array(	"intitule" => array(	"nom_complet" => "Mention",
																				"unique" => "1",
																				"not_null" => "0" )
												)
					);
