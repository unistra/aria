...
<?php
   ...
   if($TESTMODE==1)
      ...
      $condition_normale="AND $_DBC_cand_id NOT IN (SELECT $_module_apogee_DBC_numeros_opi_cand_id FROM $_module_apogee_DB_numeros_opi WHERE $_module_apogee_DBC_numeros_opi_ligne_voeux='')";
   ...
   $result=db_query($dbr, "SELECT $_DBC_candidat_nom, $_DBC_candidat_prenom, $_DBC_candidat_prenom2, $_DBC_candidat_date_naissance,
                                 ...
                                 $_module_apogee_DBC_config_message_reserve, $_DBC_candidat_nom_naissance
                           ...
                           AND ($_module_apogee_DBC_activ_lp='t' OR $_module_apogee_DBC_activ_pe='t')
