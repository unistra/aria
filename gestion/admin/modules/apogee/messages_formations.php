          ...
          list($msg_id, $msg_nom, $msg_contenu, $msg_type)=db_fetch_row($result, $i);
               ...
               print("<tr>
                         ...
                         <td class='td-droite fond_menu'>
                            <textarea name='message_lp' cols='100' rows='12'><?php echo htmlspecialchars(stripslashes($msg_contenu), ENT_QUOTES, $GLOBALS[default_htmlspecialchars_encoding]); ?></textarea>                      
                         </td> 
