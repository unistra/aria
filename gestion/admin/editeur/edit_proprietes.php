...
<div class='main'>
	<?php
		...
		<tr>
			...
			<td class='td-droite fond_menu' colspan='2'>
				<input type='text' name='largeur_logo' value='<?php if(isset($current_largeur_logo)) echo htmlspecialchars(stripslashes($current_largeur_logo), ENT_QUOTES, $default_htmlspecialchars_encoding); else print("32"); ?>' maxlength='3' size='4'>
			</td>
		</tr>
		<tr>
			<td class='td-gauche fond_menu2'>
			...
			<td class='td-droite fond_menu' colspan='2'>
				<textarea name='texte_logo' rows='5' cols='60'><?php
					if(isset($current_txt_logo)) echo htmlspecialchars(stripslashes($current_txt_logo), ENT_QUOTES, $default_htmlspecialchars_encoding);
				?></textarea>
			</td>
		</tr>
		<tr>
			...
			<td class='td-droite fond_menu' colspan='2'>
				<textarea name='texte_signature' rows='5' cols='60'><?php
					if(isset($current_txt_sign)) echo htmlspecialchars(stripslashes($current_txt_sign), ENT_QUOTES, $default_htmlspecialchars_encoding);
				?></textarea>
			</td>
		</tr>
		<tr>
			...
			<td class='td-droite fond_menu' colspan='2'>
				<textarea name='texte_scol' rows='7' cols='60'><?php
					if(isset($current_txt_scol)) echo htmlspecialchars(stripslashes($current_txt_scol), ENT_QUOTES, $default_htmlspecialchars_encoding);
				?></textarea>
			</td>
		</tr>
		<tr>
