...
<?php
  ...
  if(isset($_POST["go_valider"]) || isset($_POST["go_valider_x"]))
  {
    ...
    if(!empty($comp_logo))
      $comp_logo=htmlspecialchars(validate_filename($comp_logo),ENT_QUOTES, $GLOBALS["default_htmlspecialchars_encoding"], FALSE);
    ...
    if(!isset($move_error) && !isset($image_wrong_type) && !isset($file_wrong_size))
    {
      ...
      db_query($dbr,"UPDATE $_DB_composantes SET  $update_logo
                                    $_DBU_composantes_txt_logo='".preg_replace("/'/","''", stripslashes($comp_txt_logo))."',
...
<div class='main'>
  ...
  <tr>
    ...
    <td class='td-droite fond_menu'>
      ...
      <b>Position :</b>
      <br>Valeur de X (en mm) : <input type='text' name='adr_pos_x' value='<?php if(isset($comp_adr_pos_x)) echo htmlspecialchars(stripslashes($comp_adr_pos_x), ENT_QUOTES, $GLOBALS["default_htmlspecialchars_encoding"], FALSE); else print("109"); ?>' maxlength='3' size='4'>
      <br>Valeur de Y (en mm) : <input type='text' name='adr_pos_y' value='<?php if(isset($comp_adr_pos_y)) echo htmlspecialchars(stripslashes($comp_adr_pos_y), ENT_QUOTES, $GLOBALS["default_htmlspecialchars_encoding"], FALSE); else print("42"); ?>' maxlength='3' size='4'>
    </td>
  </tr>
  <tr>
    <td class='td-gauche fond_menu2'>
    ...
    <td class='td-droite fond_menu'>
      <font class='Texte_menu'>
      <b>Position :</b>
      <br>Valeur de X (en mm) : <input type='text' name='corps_pos_x' value='<?php if(isset($comp_corps_pos_x)) echo htmlspecialchars(stripslashes($comp_corps_pos_x), ENT_QUOTES, $GLOBALS["default_htmlspecialchars_encoding"], FALSE); else print("60"); ?>' maxlength='3' size='4'>
      <br>Valeur de Y (en mm) : <input type='text' name='corps_pos_y' value='<?php if(isset($comp_corps_pos_y)) echo htmlspecialchars(stripslashes($comp_corps_pos_y), ENT_QUOTES, $GLOBALS["default_htmlspecialchars_encoding"], FALSE); else print("78"); ?>' maxlength='3' size='4'>
    </td>
  </tr>
  <tr>
    <td class='td-gauche fond_menu2'>
    ...
    <td class='td-droite fond_menu' colspan='2'>
      <textarea name='texte_signature' rows='5' cols='60'><?php
        if(isset($comp_txt_sign)) echo htmlspecialchars(stripslashes($comp_txt_sign), ENT_QUOTES, $GLOBALS["default_htmlspecialchars_encoding"], FALSE);
      ?></textarea>
    </td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td class='td-droite fond_menu' colspan='2'>
      <input type='text' name='largeur_logo' value='<?php if(isset($comp_largeur_logo)) echo htmlspecialchars(stripslashes($comp_largeur_logo), ENT_QUOTES, $GLOBALS["default_htmlspecialchars_encoding"], FALSE); else print("32"); ?>' maxlength='3' size='4'>
    </td>
  </tr>
  <tr>
    <td class='td-gauche fond_menu2'>
    ...
    <td class='td-droite fond_menu' colspan='2'>
      <textarea name='texte_logo' rows='5' cols='60'><?php
        if(isset($comp_txt_logo)) echo htmlspecialchars(stripslashes($comp_txt_logo), ENT_QUOTES, $GLOBALS["default_htmlspecialchars_encoding"], FALSE);
      ?></textarea>
    </td>
  </tr>
  <tr>
    ...
    <td class='td-droite fond_menu' colspan='2'>
      <textarea name='texte_scol' rows='7' cols='60'><?php
        if(isset($comp_txt_scol)) echo htmlspecialchars(stripslashes($comp_txt_scol), ENT_QUOTES, $GLOBALS["default_htmlspecialchars_encoding"], FALSE);
      ?></textarea>
    </td>
  </tr>
  </table>
