...
"formation" => '$txt=preg_replace("/%Formation%/", $candidature_array["texte_formation"], $txt);
          ...
          $txt=preg_replace("/%FORMATION%/", mb_strtoupper($candidature_array["texte_formation"], "UTF-8"), $txt);',

"responsable" => '$txt=preg_replace("/%Responsable%/", ucwords(mb_strtolower($candidature_array["responsable"], "UTF-8")), $txt);
          $txt=preg_replace("/%responsable%/", ucwords(mb_strtolower($candidature_array["responsable"], "UTF-8")), $txt);
          $txt=preg_replace("/%RESPONSABLE%/", mb_strtoupper($candidature_array["responsable"], "UTF-8"), $txt);',

"courriel_responsable" => '$txt=preg_replace("/%courriel_responsable%/", mb_strtolower($candidature_array["responsable_email"], "UTF-8"), $txt);',
...
"transmission" => '$txt=preg_replace("/%Transmission%/", $candidature_array["transmission"], $txt);
            $txt=preg_replace("/%transmission%/", mb_strtolower($candidature_array["transmission"], "UTF-8"), $txt);
            $txt=preg_replace("/%TRANSMISSION%/", mb_strtoupper($candidature_array["transmission"], "UTF-8"), $txt);',
