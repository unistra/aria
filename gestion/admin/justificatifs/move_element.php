...
/*
	if(isset($_GET["co"]) && isset($_GET["dir"]))
	{
...
*/
	...
	if(isset($_SESSION["filtre_justif"]) && $_SESSION["filtre_justif"]!="-1")
		$propspec_id=$_SESSION["filtre_justif"];
	...
	db_query($dbr,"UPDATE $_DB_justifs_jf SET $_DBU_justifs_jf_ordre='$temp_ordre'
							WHERE $_DBU_justifs_jf_propspec_id='$propspec_id'
							AND 	$_DBU_justifs_jf_ordre='$ordre_cible';

						UPDATE $_DB_justifs_jf SET $_DBU_justifs_jf_ordre='$ordre_cible'
							WHERE $_DBU_justifs_jf_propspec_id='$propspec_id'
							AND $_DBU_justifs_jf_ordre='$co';

						UPDATE $_DB_justifs_jf SET $_DBU_justifs_jf_ordre='$co'
							WHERE $_DBU_justifs_jf_propspec_id='$propspec_id'
							AND $_DBU_justifs_jf_ordre='$temp_ordre'");
