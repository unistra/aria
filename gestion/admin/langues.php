...
<?php
	...
	$titre_page="Cursus des candidats - Gestion des langues lues/parlées/écrites";

/*
	// table concernée
	$nom_table="liste_langues";
...
*/
	...
	$table=array("nom" => "liste_langues",
					 "pkey" => "id",
					 "selection" => "langue",
					 "order" => "langue",
					 "colonnes" => array("langue" => array("nom_complet" => "Langue",
																		"unique" => "1",
																		"not_null" => "1" )
												)
					);

	$warning="Attention : cette liste est <strong>GLOBALE</strong>, ne la modifiez que si vous êtes sûr de ce que vous faites.</center>";
