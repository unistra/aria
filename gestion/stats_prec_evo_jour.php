...
<div class='main'>
  <?php
    ...
    if($rows)
    {
      ...
      if(mb_substr(date("y"), 0,1, "UTF-8") == "0")
      {
        $debut_date="200";
        $sub_annee_len=1;
      }
      ...
      $old_mois=$__MOIS[mb_substr($cand_id, $sub_annee_len, 2, "UTF-8")];
      $old_jour=mb_substr($cand_id, $sub_annee_len+2, 2, "UTF-8");
      ...
      for($i=0; $i<$rows; $i++)
      {
        ...
        $mois=$__MOIS[mb_substr($cand_id, $sub_annee_len, 2, "UTF-8")];
        $jour=mb_substr($cand_id, $sub_annee_len+2, 2, "UTF-8");
