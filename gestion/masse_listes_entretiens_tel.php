  ...
  elseif(isset($_POST["valider"]) || isset($_POST["valider_x"]) && isset($_SESSION["propspec_id"]))
  {
    ...
    if(array_key_exists(0, $jour_salle_array) && array_key_exists(1, $jour_salle_array))
    {
      ...
      else
      {
        ...
        $lien_form="<a href='lettres/liste_entretiens_tel.php?jour=$jour&id_form=$propspec_id' class='lien_bleu_10' target='_blank'>Document prêt - cliquez ici pour l'ouvrir (ouverture dans une nouvelle page)</a>";
        $resultat=2;
      }
    }
  }
...
<div class='main'>
  <?php
    titre_page_icone("Entretiens : générer une liste de candidats convoqués à un entretien téléphonique", "kpersonalizer_32x32_fond.png", 15, "L");

    message("Seules les formations dont certains candidats sont convocables à l'entretien téléphonique apparaîtront", $__INFO);
    ...
    if(!isset($resultat))
    {
      ...
      else
      {
        print("<font class='Texte_important'><b>
              ...
              <br>- soit aucun candidat n'est convocable à l'entretien téléphonique
