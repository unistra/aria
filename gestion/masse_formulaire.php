...
<?php
  ...
  elseif(isset($_POST["valider"]) || isset($_POST["valider_x"]) && isset($_SESSION["propspec_id"]))
  {
    ...
    else
    {
      ...
      $lien_form="<a href='lettres/formulaire_commission.php?jour_inf=$jour_inf&jour_sup=$jour_sup&id_form=$propspec_id' class='lien_bleu_10' target='_blank'>Document prêt - cliquez ici pour l'ouvrir (ouverture dans une nouvelle page)</a>";
      $resultat=2;
    }
  }
...
<div class='main'>
  <?php
    titre_page_icone("Générer les Formulaires de Commission en masse", "kpersonalizer_32x32_fond.png", 15, "L");

    message("<center>Seuls les Formulaires des dossiers recevables seront générés</center>", $__INFO);
    ...
    if(isset($_GET["erreur"]) && $_GET["erreur"]==1)
      message("Erreur lors de la génération des formulaires. Un message a été envoyé à l'administrateur.", $__ERREUR);
